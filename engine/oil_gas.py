...
from constants import COMPRESSOR_POWER_COEFF, CO2_FACTOR
...
def simulate_oil_gas(inputs: dict) -> dict:
    ...
    recovered_gas = min(flare_gas, fuel_demand) * uptime / 100
    flared_gas    = max(0, flare_gas - min(flare_gas, fuel_demand)) * uptime / 100
